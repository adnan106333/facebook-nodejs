...
app.get('/lastName',         api.lastName);
app.get('/friendList',       api.friendList);
app.get('/comments',         api.comment);
app.get('/photo',            api.photo);
app.get('/profilephoto',     api.getUserProfilePicture);
app.get('/album',            api.album);
app.get('/albumbyid',        api.albumByID);
app.get('/location',         api.location);
app.get('/video',            api.video);
app.post('/videoLike',        api.videoLikes);
app.get('/userInfo',         api.getUserInfoByID);
app.get('/aboutMe',         api.aboutMe);


// app.get('/dbConnection',         api.dbConnection);
